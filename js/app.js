...
for (var i = 5; i >= 0; i--) {
  ...
  var answer7 = prompt(question7).toLowerCase();
  if (answer7 === correctAnswer[0].toLowerCase() || answer7 === correctAnswer[1].toLowerCase() || answer7 === correctAnswer[2].toLowerCase()) {
